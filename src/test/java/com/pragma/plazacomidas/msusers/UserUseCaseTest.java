...
public class UserUseCaseTest {
    ...
    void createOwnerTest() {
        OwnerModel ownerModel = new OwnerModel(null, "Daron", "Mercado", "111234567", "+573005698325", LocalDate.of(1990,5,20), "daron@gmail.com", "12345", null);
        OwnerModel savedOwner = new OwnerModel(1L, "Daron", "Mercado", "111234567", "+573005698325", LocalDate.of(1990,5,20), "daron@gmail.com", "12345", "ROLE_OWNER");
        ...
        when(userPersistencePort.saveOwner(any(OwnerModel.class))).thenReturn(savedOwner);

        OwnerModel result = userUseCase.createOwner(ownerModel);
        
        assertEquals(savedOwner, result);
        assertEquals(1L, result.getId());
        assertEquals("ROLE_OWNER", result.getRole());
        verify(passwordEncoderPort, times(1)).encode("12345");
        verify(userPersistencePort, times(1)).saveOwner(any(OwnerModel.class));
    ...
    void emailInvalidTest(){
        OwnerModel ownerModel = new OwnerModel(null, "Daron", "Mercado", "111234567", "+573005698325", LocalDate.of(1990,5,20), "daronQgmail.com", "12344", null);
    ...
    void phoneInvalidTest(){
        OwnerModel ownerModel = new OwnerModel(null, "Daron", "Mercado", "111234567", "30056983", LocalDate.of(1990,5,20), "daron@gmail.com", "12345", null);
        DomainException exception = assertThrows(DomainException.class, 
            () -> userUseCase.createOwner(ownerModel));
    ...
    @Test
    void ccInvalidTest(){
        OwnerModel ownerModel = new OwnerModel(null, "Daron", "Mercado", "11123456s", "3005698325", LocalDate.of(1990,5,20), "daron@gmail.com", "12345", null);
        DomainException exception = assertThrows(DomainException.class, 
            () -> userUseCase.createOwner(ownerModel));
    ...
    void dateOfBirthInvalidTest(){
        OwnerModel ownerModel = new OwnerModel(null, "Daron", "Mercado", "111234567", "3005698325", LocalDate.of(LocalDate.now().getYear() + 1, 1, 1), "daron@gmail.com", "12345", null);
        DomainException exception = assertThrows(DomainException.class, 
            () -> userUseCase.createOwner(ownerModel));
    ...
    void ownerNotAdultTest(){
        OwnerModel ownerModel = new OwnerModel(null, "Daron", "Mercado", "111234567", "3005698325", LocalDate.of(LocalDate.now().getYear() - 10, 1, 1), "daron@gmail.com", "12345", null);
        DomainException exception = assertThrows(DomainException.class, 
            () -> userUseCase.createOwner(ownerModel));
